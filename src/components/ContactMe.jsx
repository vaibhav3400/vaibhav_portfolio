                            ...
                            <Row>
                                ...
                                <Col className="m-5 rounded-3 p-2 pb-5" style={{ boxShadow: "0.47px 0.47px 5.8px 4px #B565A7" }}>
                                    ...
                                    <Row className="fs-3 fw-bold py-2 text-white">
                                        ...
                                        <Col className='text-break mx-2'>
                                            <a href="mailto:vaibhavvkulkarni34@gmail.com" target='_blank'>vaibhavvkulkarni34@gmail.com</a>
                                        </Col>
                                    </Row>
                                    <Row className="fs-3 fw-bold py-2">
                                        ...
                                        <Col  className='text-break mx-2'>
                                            <a href="tel:+919967393630" target='_blank'>+91 9967393630</a>
                                        </Col>
                                    </Row>
                                ...
                                <Col className="m-5 rounded-3 p-2 pb-5" ref={ref} style={{
                                    ...
                                    <Row className="fs-3 fw-bold py-2 text-white">
                                        ...
                                        <Col  className='text-break mx-2'>
                                            <a href="https://www.linkedin.com/in/vaibhav-kulkarni-901268320" target='_blank'>https://www.linkedin.com/in/vaibhav-kulkarni-901268320</a>
                                        </Col>
                                    </Row>
                                    <Row className="fs-3 fw-bold py-2">
                                        <Col xs={2} className=" text-end mx-2">
                                        ...
                                        <Col className='text-break mx-2'>
                                            <a href="https://github.com/vaibhav3400" target='_blank'>https://github.com/vaibhav3400</a>
                                        </Col>
                                    </Row>
